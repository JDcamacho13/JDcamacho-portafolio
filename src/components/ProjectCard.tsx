    ...
    <div className="w-80 md:w-96 mx-auto rounded-xl bg-gray-50 shadow-lg dark:bg-gray-800 overflow-hidden">
      ...
      <div className="px-8 py-2">
        ...
        <div className="flex flex-row justify-center py-8 gap-8 items-center">
          ...
          <a href={linkRepo} target="_blank" rel="noreferrer" className="p-2 border border-transparent hover:bg-sky-400 hover:border-sky-800 hover:dark:border-sky-600 hover:dark:bg-sky-800 transition rounded-full" >
